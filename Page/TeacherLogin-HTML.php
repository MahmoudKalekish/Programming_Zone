...
<div class="login-page">
  <div class="form">
    <form class="register-form" method ="post">
	  ...
	  <input id="graduation" name="graduation" type="text" class="input" placeholder="Education level" required/>
    ...
    <form class="login-form" method ="post">
      ...
      <a href="./Course-HTML.php"><button type="submit" name="login" id="login" >Signin</button></a>
...
<?php
	...
	if(isset($_POST["register"]) && $_POST["firstname"] != "" && $_POST["lastname"] != "" && $_POST["phonenumber"] != "" && $_POST["birthdate"] != "" && $_POST["email"] != "" && $_POST["password"] != "" && $_POST["graduation"] != "") 
	{
		session_start();
		...
		if(strlen($password) < 8 || !$number || !$uppercase || !$lowercase || !$specialChars) {?>
			<script>
				...
				document.location.href="./TeacherLogin-HTML.php" 
			</script>
			<?php
		} 
			else {
				$query="INSERT INTO `teacher` (`Firstname`,`Lastname`, `Phonenumber`,`Birthdate`,`Email`, `Password`, `graduation`) VALUES ('$firstname','$lastname','$phonenumber','$birthdate','$email','$password','$graduation')";
...
?>
			<script> document.location.href="./TeacherCourse-HTML.php" </script>
		<?php
				}
	...
	if(isset($_POST["login"]) && $_POST["email"] != "" && $_POST["password"] != "") {
		...
		$email = $_POST["email"];
		$password = $_POST["password"];
		$usersSelect="SELECT * from teacher where email='$email' and password='$password'";
